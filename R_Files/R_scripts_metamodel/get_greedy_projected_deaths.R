## This can be used to get the projected deaths of the solution determined by the greedy algorithm
...
naloxone_data <- read.csv("greedy_solution_distribution.csv")
print(naloxone_data)
...
output_file <- paste0("greedy_solution_distribution_deaths.csv")
