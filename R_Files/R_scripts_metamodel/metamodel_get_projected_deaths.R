## This file imports the projected deaths in the naloxone file and gets the projected deaths. 
...
naloxone_data <- read.csv("best_potential_solutions.csv")
...
num_cores <- 32  
n.reds <- 3*num_cores    # number of redistribution schemes
...
output_file <- paste0("naloxone_param_", result, ".csv")
